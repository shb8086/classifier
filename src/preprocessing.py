...
def plot_distribution(df, column_name, file_name):
  ...
  plt.savefig(f"output/plots/{file_name}.png")
...
def plot_based_distribution(df, col1, col2):
  ...
  plt.savefig(f"output/plots/{col1}_{col2}_distribution_chart.png")
...
plt.savefig("output/plots/Na_to_K_ratio_based_on_Age_gender.png")
...
X.to_csv("dataset/modified_dataset.csv", index=False)
...
print("Preprocessed training and test sets saved successfully!")